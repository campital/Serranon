...
for i in *.c
do
gcc $i -o ../kernel_bin/`basename $i .c`.o -Wall -O -fstrength-reduce -m32 -fomit-frame-pointer -finline-functions -fno-stack-protector -nostdinc -fno-builtin -fno-pie -c
done
cd ../..
